...
df = pd.read_csv(r'C:\Users\Arun\PycharmProjects\Predictor\templates/after removing duplicates.csv')
...
app.layout=dbc.Container(
    [
    html.H1("Dashboard_1",style={"font-family": "Arial, Helvetica, sans-serif","letter-spacing": 3}),
    html.Hr(),
    dbc.Row(
        [
